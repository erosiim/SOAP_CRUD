 ...
 * 
 */
@WebServiceClient(name = "Calculadora", targetNamespace = "http://ejemplo.org/", wsdlLocation = "http://localhost:8084/EjemploWebServiceSOAP/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORA_QNAME = new QName("http://ejemplo.org/", "Calculadora");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/EjemploWebServiceSOAP/Calculadora?wsdl");
    ...
    public Calculadora getCalculadoraPort() {
        return super.getPort(new QName("http://ejemplo.org/", "CalculadoraPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ejemplo.org/", "CalculadoraPort"), Calculadora.class, features);
    }
